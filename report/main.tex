...
\begin{table}[t]
   ...
   \begin{figure}[ht!]
      \centering
      \includegraphics[width=.3\textwidth]{assets/fig_hp/nn_architecture.png}
   ...
   \begin{figure}[ht!]
      \centering
      \includegraphics[width=.3\textwidth]{assets/fig_hp/epsilon.initial.png}
      \caption{Comparison between five different architectures. The think line represents the average moves done per episode, while the faded line is the standard deviation. 
      }
      \label{comp_epsilon}
   \end{figure}
   ...
   \begin{figure}[ht!]
      \centering
      \includegraphics[width=.3\textwidth]{assets/fig_hp/temp.initial.png}
      \caption{Comparison between five different architectures. The think line represents the average moves done per episode, while the faded line is the standard deviation. 
      }
      \label{comp_temp}
   \end{figure}
...
Unfortunately, only a few runs, with respect to the hyperparameter space size, could be collected (166) due to time limitation
and many of the insights have to be taken with care since there is not much statistical support for them.
Furthermore, it must be ensured that the policy-specific parameters such as the initial epsilon value or the initial temp value are only evaluated for runs in which the corresponding action selection policy has been selected. 
