...
In \autoref{dqn-ablation-study}, the effect of experience replay and a target network are investigated.
...
In this subscetion we ablation study is performed \autoref{fig_ablation}. After having found the best configuration for the hyperparameters, we are comparing the different solutions to improve the DQN algorithm.\\
