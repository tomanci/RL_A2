...
\end{figure}
   ...
   after that a constant growth has been recorded, and the data shows at the end of the training, the agent was able to keep the pole in the vertical position for more than 200 moves. Another consideration weighs-in the preference of this architecture over $4-64-32-32-2$ is that it has a good trade-off between depth performance and size.\\
...
\begin{figure}[ht!]
   ...
   \caption{Ablation study between four different approaches. The think line represents the average moves done per episode, while the faded line is the standard deviation. 
   }
   \label{fig_ablation}
\end{figure}
